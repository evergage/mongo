...
namespace mongo {
    ...
    TEST(MatchExpressionParserTest, BitTestMatchExpressionValidArray) {
        ...
        ASSERT_EQUALS(NumberLong, bsonArrayLongLong[0].type());
        ASSERT_EQUALS(NumberLong, bsonArrayLongLong[1].type());
        ASSERT_EQUALS(NumberLong, bsonArrayLongLong[2].type());
        ASSERT_EQUALS(NumberLong, bsonArrayLongLong[3].type());
