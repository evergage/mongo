...
namespace mongo {
    ...
    */
    ...
    TEST(BitTestMatchExpression, DoesNotMatchOther) {
        ...
        ASSERT_EQUALS((size_t)0, balls.numBitPositions());
        ASSERT_EQUALS((size_t)0, ballc.numBitPositions());
        ASSERT_EQUALS((size_t)0, banys.numBitPositions());
        ASSERT_EQUALS((size_t)0, banyc.numBitPositions());
    ...
    TEST(BitTestMatchExpression, MatchesInteger) {
        ...
        ASSERT_EQUALS((size_t)4, balls.numBitPositions());
        ASSERT_EQUALS((size_t)3, ballc.numBitPositions());
        ASSERT_EQUALS((size_t)4, banys.numBitPositions());
        ASSERT_EQUALS((size_t)3, banyc.numBitPositions());
        ASSERT(balls.matchesSingleElement(match1["a"]));
        ASSERT(balls.matchesSingleElement(match2["a"]));
        ASSERT(balls.matchesSingleElement(match3["a"]));
        ASSERT(ballc.matchesSingleElement(match1["a"]));
    ...
    TEST(BitTestMatchExpression, MatchesNegativeInteger) {
        ...
        ASSERT_OK(banys.init("a", bitPositionsSet));
        ASSERT_OK(banyc.init("a", bitPositionsClear));
        ASSERT_EQUALS((size_t)5, balls.numBitPositions());
        ASSERT_EQUALS((size_t)4, ballc.numBitPositions());
        ASSERT_EQUALS((size_t)5, banys.numBitPositions());
        ASSERT_EQUALS((size_t)4, banyc.numBitPositions());
        ASSERT(balls.matchesSingleElement(match1["a"]));
        ASSERT(balls.matchesSingleElement(match2["a"]));
        ASSERT(balls.matchesSingleElement(match3["a"]));
        ASSERT(ballc.matchesSingleElement(match1["a"]));
